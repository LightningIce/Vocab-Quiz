...
<head>
    ...
    <meta name="description" content="Easy Quizzes Dashboard for Students">
    <title>Easy Quizzes Dashboard (Students)</title>
...
<body>
    ...
    <main>
        <div class="admin-dashboard-banner">Easy Quizzes Dashboard (Students)</div>
