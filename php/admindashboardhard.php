...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'admin') {
    ...
    $_SESSION['redirect_to'] = 'admindashboardhard.php';
...
// Prepare the SQL statement to fetch Hard quizzes created by the admin
$stmt = $conn->prepare("SELECT quiz_id, quiz_title, description, category FROM quizzes WHERE created_by = ? AND category = 'Hard'");
if ($stmt === false) {
...
<head>
    ...
    <meta name="description" content="Hard Quizzes Dashboard for Admin">
    <title>Hard Quizzes Dashboard</title>
...
<body>
    ...
    <main>
        <div class="admin-dashboard-banner">Hard Quizzes Dashboard</div>
        <div class="admin-dashboard-container">
            <div class="admin-level">
                <div class="admin-dashboard-header">
                    <div class="admin-dashboard-title">Hard Quizzes</div>
