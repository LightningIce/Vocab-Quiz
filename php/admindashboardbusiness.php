...
<head>
    ...
    <meta name="description" content="Business Quizzes Dashboard for Admin">
    <title>Business Quizzes Dashboard</title>
...
<body>
    ...
    <main>
        <div class="admin-dashboard-banner">Business Quizzes Dashboard</div>
