...
<head>
    ...
    <meta name="description" content="Hard Quizzes Dashboard for Students">
    <title>Hard Quizzes Dashboard (Students)</title>
...
<body>
    ...
    <main>
        <div class="admin-dashboard-banner">Hard Quizzes Dashboard (Students)</div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function openModal(quiz) {
                ...
                takeQuizButton.onclick = () => {
                    window.location.href = `takequiz.php?quiz_id=${quiz.id}`;
                };
